...
public class LogUtils {
	...
	/** 是否允许输出log */
	// private static int mDebuggable = DataService.DEBUGLEVEL;
	//private static int mDebuggable = MyApplication.getInstance().LogSwitch();
